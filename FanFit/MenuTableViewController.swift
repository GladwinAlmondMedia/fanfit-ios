...
class MenuTableViewController: UITableViewController {
    ...
    var menu = ["Dashboard", "Profile", "Club", "Competition"]
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        case 1:
            performSegueWithIdentifier("menuToProfile", sender: self)
        case 2:
            performSegueWithIdentifier("menuToClub", sender: self)
        case 3:
            performSegueWithIdentifier("menuToCompetition", sender: self)
        default:
            print("Default")
        }
    }
