...
class HealthKitManager {
    ...
    func setHKQuantityType() -> String {
        
        var hkQType = ""
        
        switch App.Memory.currentActivityCategory.name {
        case "Cycling":
            hkQType = HKQuantityTypeIdentifierDistanceCycling
        default:
            hkQType = HKQuantityTypeIdentifierDistanceWalkingRunning
        }
    ...
    func authorizeHealthKit(completion: ((success: Bool, error: NSError!) -> Void)!) {
        ...
        let healthDataToWrite = Set(arrayLiteral: HKObjectType.quantityTypeForIdentifier(setHKQuantityType())!)
    ...
    func saveDistance(distanceRecorded: Double, date: NSDate ) {
        ...
        let distanceType = HKQuantityType.quantityTypeForIdentifier(setHKQuantityType())
        print(setHKQuantityType())
